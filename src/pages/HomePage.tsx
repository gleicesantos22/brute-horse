            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto my-16">
              ...
              <div className="flex flex-col items-center space-y-3 p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    100% pure, scientifically-tested compounds
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-center space-y-3 p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
            ...
            <div className="space-y-8">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-5xl font-bold text-gray-900 mb-6 leading-tight">
                  Premium Quality You Can{" "}
                  <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
                    Trust
                  </span>
                </h2>
                <p className="text-2xl text-gray-600 leading-relaxed font-light mb-12">
                  Manufactured in FDA-approved facilities with the highest
                  quality standards, using only the finest natural ingredients
                  sourced globally
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8 order-1 lg:order-2">
                ...
                <p className="text-xl text-gray-300 leading-relaxed">
                  Your investment today is protected by our iron-clad 180-day
                  100% money-back guarantee. If you're not completely amazed by
                  how BRUTE HORSE transforms your vitality and performance,
                  simply contact us within 180 days for a full refund. No
          ...
          <div className="bg-white relative overflow-hidden p-4">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-16">
                92% of our customers choose the 6-bottle package - our
                recommended option for optimal results, maximum savings, and the
          ...
          <div className="text-center mb-16">
            ...
            <div className="mb-12">
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 max-w-4xl mx-auto">
                <a
                  href="/privacy-policy"
                  className="text-gray-300 hover:text-white text-sm font-medium transition-colors duration-200 hover:underline"
                >
                  Privacy Policy
                </a>
                <a
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              <p className="text-gray-300 text-lg">
                Copyright © 2024 | BRUTE HORSE All Rights Reserved
              </p>
              ...
              <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/20 rounded-2xl p-8">
                <p className="text-sm text-gray-300 leading-relaxed">
                  ...
                  treat, cure, or prevent any disease. Individual results may
                  vary. Consult your healthcare provider before use.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-center">
              <div className="inline-flex items-center space-x-4 bg-white/5 px-8 py-4 rounded-2xl backdrop-blur-sm border border-white/10">
                ...
                <p className="text-sm text-gray-300 font-medium">
                  2045 S Carpenter St, United States. Secure SSL Encrypted
                  Ordering.
                </p>
              </div>
            </div>
